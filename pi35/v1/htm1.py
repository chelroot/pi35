...
#
 if (GPIO.input(26)) == 0:
   if bb52 == 1:
    a2 = open(pwd1, 'a')
    a2.write('<br />' + '52' + '  off  ' + str(now) + '\n'),
    a2.close()
   bb52 = 0
 if (GPIO.input(26)) == 1:
   if bb52 == 0:
    a2 = open(pwd1, 'a')
    a2.write('<br />' + '52' + '  on  ' + str(now) + '\n'),
    a2.close()
   bb52 = 1
#
 if (GPIO.input(25)) == 0:
   if bb53 == 1:
    a2 = open(pwd1, 'a')
    a2.write('<br />' + '53' + '  off  ' + str(now) + '\n'),
    a2.close()
   bb53 = 0
 if (GPIO.input(25)) == 1:
   if bb53 == 0:
    a2 = open(pwd1, 'a')
    a2.write('<br />' + '53' + '  on  ' + str(now) + '\n'),
    a2.close()
   bb53 = 1
#
 if (GPIO.input(24)) == 0:
...
#
 if (GPIO.input(23)) == 0:
   if bb55 == 1:
    a2 = open(pwd1, 'a')
    a2.write('<br />' + '55' + '  off  ' + str(now) + '\n'),
    a2.close()
   bb55 = 0
 if (GPIO.input(23)) == 1:
   if bb55 == 0:
    a2 = open(pwd1, 'a')
    a2.write('<br />' + '55' + '  on  ' + str(now) + '\n'),
    a2.close()
   bb55 = 1
#
 if (GPIO.input(22)) == 0:
